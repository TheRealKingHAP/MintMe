...
function TopUsers({}: Props) {
  ...
  return (
    <div id='section-2' className=' w-3/4 h-max  2xl:h-screen  flex flex-col items-center'>
        <h3 className='font-bold text-gray-800 dark:text-white text-lg text-center xl:w-1/2  xl:text-xl 2xl:text-4xl'>Look who is using our platform to receive donations via crypto</h3>
