...
function SkeletonTopUserCard({}: Props) {
  return (
<div className='flex flex-col space-y-5 bg-gray-100 dark:bg-dark-mode-background-card-color p-2 rounded-md items-center text-center 2xl:items-start 2xl:text-left  w-52 h-max cursor-pointer'>
