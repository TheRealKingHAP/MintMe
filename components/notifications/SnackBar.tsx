...
function SnackBar({message, status, isVisible}: Props) {  
    return (
        <div className={`bg-white shadow-xl dark:shadow-none dark:bg-dark-mode-background-500 dark:text-white text-gray-800 w-3/4 2xl:w-72 p-2 fixed bottom-2 left-1/2 -translate-x-1/2 rounded-md ${!isVisible ? 'translate-y-[calc(100vh)]' : 'translate-y-0'}  transition-all ease-in-out duration-300`}>
